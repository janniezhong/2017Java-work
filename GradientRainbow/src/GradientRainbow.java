...
public class GradientRainbow extends JPanel
	implements ActionListener
{
  ...
  //
	...
	private int green = 0;
	private int blue = 0;
	private Color rainbowColor = new Color(red, green, blue);
...
/*
 ...
 // Draw the sky-color semicircle:
   ...
   for(int t = 0; t < largeRadius; t++) {
    
	   g.setColor(rainbowColor);	   
	   g.fillArc(xCenter-largeRadius+t, yCenter-largeRadius+t, 2*(largeRadius-t), 2*(largeRadius-t), 0, 180);
