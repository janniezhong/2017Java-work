...
public class ShelbyTimeTestCheck3 {
	...
	public static void testChoice() {
		//Testing the private methods fixMinutes and fixHours
		Time t1 = new Time(0,0);
		Time t2 = new Time(5,40);
		Time t3 = new Time(25,30);
		Time t4 = new Time(8,100);
		Time t5 = new Time(-5,30);
		Time t6 = new Time (8, 10000);
		...
		int sec1 = t1.toSeconds();
		int sec2 = t2.toSeconds();
		int sec3 = t3.toSeconds();
		int sec4 = t4.toSeconds();
		int sec5 = t5.toSeconds();
		int sec6 = t6.toSeconds();
