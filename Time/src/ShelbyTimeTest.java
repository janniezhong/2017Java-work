...
public class ShelbyTimeTest {
	...
	public static void testConstructors() {
		...
		Time t6 = new Time (745);
		Time t7 = new Time (0);
		Time t8 = new Time (24*60);
		Time t9 = new Time (60*8 + 15);
		Time t10 = new Time (60*13 + 45);
		...
		System.out.println("Time t6 = " + t6);
		System.out.println("Time t7 = " + t7);
		System.out.println("Time t8 = " + t8);
		System.out.println("Time t9 = " + t9);
		System.out.println("Time t10 = " + t10);
