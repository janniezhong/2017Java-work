    ...
    implements ActionListener
{
  ...
  private JTextArea original, marked, words, wordCount;
  private JButton go;
  ...
  public void refresh()
  {
    ...
    wordCount.setText(analyzer.getWordCount(text));
  }
  ...
  private void setupGui()
  {
    ...
    wordCount = new JTextArea(10, 10);
    wordCount.setEditable(false);
    wordCount.setBackground(Color.LIGHT_GRAY);
    JScrollPane wordCountPane = new JScrollPane(wordCount,
              ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
              ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
