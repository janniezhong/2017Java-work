                            ...
                            implements ActionListener
{
  ...
  private JButton deposit25c, deposit10c, deposit5c, go, returnMoney;
  ...
  public VendingMachine(String brand, Color color, int price, ImageIcon coin)
  {
    ...
    returnMoney = new JButton("  Return Money ", null);
    returnMoney.addActionListener(this);
    
    go = new JButton("   ");
    go.setBackground(Color.RED);
    go.addActionListener(this);
    JPanel buttons = new JPanel(new GridLayout(4, 1, 5, 0));
    buttons.setBackground(Color.BLUE);
    buttons.add(deposit25c);
    buttons.add(deposit10c);
    buttons.add(deposit5c);
    buttons.add(returnMoney);
  ...
  public void actionPerformed(ActionEvent e)
  {
   ...
   if (b == returnMoney){
    	int change = vendor.returnMoney();
    	JOptionPane.showMessageDialog(null,
        " Change returned: " + change + "c", "Money Returned", JOptionPane.PLAIN_MESSAGE);
   }
